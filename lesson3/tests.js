describe("Arrays", function() {
  ...
  describe("hasRepeatingElements", function() {
    ...
    it("в массиве без повтор€ющихс€ элементов результат false", function() {
    ...
    it("в массиве с повтор€ющимис€ элементами в начале массива результат true", function() {
      assert.isTrue(hasRepeatingElements([1,1,1,4,2]));
    });
    
    it("в массиве с произвольно повтор€ющимис€ элементами результат true", function() {
  ...
  describe("negativeElementsSum", function() {
    ...
    it("игнорирует последующие нули в массиве, после первого встретившегос€", function() {
  ...
  describe("commonElements", function() {
    ...
    it("возвращает массив, содержащий одинаковые элементы из обоих вход€щих массивов", function() {
